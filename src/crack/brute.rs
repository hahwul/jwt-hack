...
pub fn generate_combinations_chunked(chars: &str, length: usize, chunk_size: usize) -> impl Iterator<Item = Vec<String>> {
    ...
    impl Iterator for CombinationIter {
        ...
        fn next(&mut self) -> Option<Self::Item> {
            ...
            for _ in 0..self.chunk_size {
                ...
                let combination: String = indices.iter()
                    .map(|&idx| self.char_vec[idx])
                    .collect();
...
pub fn format_time(seconds: f64) -> String {
    ...
    format!("{:02}:{:02}:{:02}", hours as u64, minutes as u64, secs as u64)
}